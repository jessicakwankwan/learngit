...
namespace homework3
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                double s1 = Convert.ToDouble(System.Console.Read());
                shape = Factory.getShape(type, s1);
            }
            else if(type == "rectangle")
            {
                double s1 = Convert.ToDouble(System.Console.Read());
                double s2 = Convert.ToDouble(System.Console.Read());
            ...
            else if (type == "triangle")
            {
                double s1 = Convert.ToDouble(System.Console.Read());
                double s2 = Convert.ToDouble(System.Console.Read());
                double s3 = Convert.ToDouble(System.Console.Read());
                shape = Factory.getShape(type, s1, s2, s3);
            }
            System.Console.WriteLine("该图形的面经为：" + shape.GetS());  
        }
    }
}